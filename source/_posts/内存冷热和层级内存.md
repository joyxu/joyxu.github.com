...
同时，可以认为pagevec是per cpu的lru cache，页面先放入当前CPU的lru cache(pagevec)中，直到pagevec中已经积累了`PAGEVEC_SIZE`（15）个页面，再获取`lruvec`的lru_lock，将这些页面批量放入lruvec中。

它们间的关系如下:

![lruvec and pagevec](/images/hot-n-cold-memory-lruvec-pagevec.png)
...
demotion的关键patch是这个[mm/migrate: demote pages during reclaim](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/mm/vmscan.c?id=26aa2d199d6f2cfa6f2ef2a5dfe891f2250e71a0)。
道理很简单，就是在`shrink_folio_list`中，swap之前，找到一个可以demote的numa node，然后通过`migrate_pages`把页面迁移过去。
...
完整的逻辑可以参考这个patch set [mm/demotion: Memory tiers and demotion](https://lore.kernel.org/lkml/20220818131042.113280-1-aneesh.kumar@linux.ibm.com/)

## promotion

promotion主要还是基于前面讲的page fault中的numa balance。

![promotion](/images/hot-n-cold-memory-promotion.png)

为了优化性能，社区有做了些优化

* 慢速内存判热promotion: [memory tiering: hot page selection](https://lwn.net/ml/linux-kernel/20220622083519.708236-1-ying.huang@intel.com/)
* 迁移过程中，减少TLB miss: [LUF(Lazy Unmap Flush) reducing tlb numbers over 90%](https://lore.kernel.org/lkml/20240531092001.30428-1-byungchul@sk.com/)

# 参考

* [Optimize Page Placement in Tiered Memory System](https://lpc.events/event/11/contributions/967/attachments/811/1654/Optimize%20Page%20Placement%20in%20Tiered%20Memory%20System.pdf)
* [Lightweight Frequency-Based Tiering for CXL Memory Systems](https://arxiv.org/html/2312.04789v1/#S9)
...
* [单机Mem冷热追踪](https://developer.aliyun.com/article/674429)
* [内存满了，会发生什么？](https://xiaolincoding.com/os/3_memory/mem_reclaim.html#%E5%86%85%E5%AD%98%E5%88%86%E9%85%8D%E7%9A%84%E8%BF%87%E7%A8%8B%E6%98%AF%E6%80%8E%E6%A0%B7%E7%9A%84)
* [Using Linux Kernel Memory Tiering](https://stevescargall.com/blog/2022/06/using-linux-kernel-memory-tiering/)
* [linux 内存回收lru算法代码注释1](https://blog.csdn.net/qq_37517281/article/details/134533485)
* [Linux Swap 从 userspace 到 kernel详解](https://blog.csdn.net/qkhhyga2016/article/details/88722458?spm=1001.2014.3001.5501)
* [Linux 内核的内存回收机制](https://bluepuni.com/archives/linux-memory-reclaim/)
* [Linux中的内存回收](https://zhuanlan.zhihu.com/p/70964195)
* [内存](https://hhb584520.github.io/kvm_blog/2017/03/06/kernel-memory.html)
* [15-内存管理篇(Part1: 原理 + page.s + swap.c)](https://blog.csdn.net/qq_42800075/article/details/105117009)
* [How The Kernel Manages Your Memory](https://manybutfinite.com/post/how-the-kernel-manages-your-memory/)
* [armv8 memory system](https://www.cnblogs.com/-9-8/p/8427402.html)
